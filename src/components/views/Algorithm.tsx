...
import AlgorithmChangelog from '../blocks/AlgorithmChangelog';
...
const scoreVariables = [
  ...
  },
  {
    ...
    content: (
      <Text>
        {`Currently as we have a high volume of learners, we prioritise matching learners who have been waiting the longest. Therefore learners who have been waiting <bold>5 days or longer</bold> are only considered eligible for matching. This includes both first search and after being matched.
  ...
  },
  {
    ...
    content: (
      <Text>{`Score calculated based on the amount of overlap in each user's time slot availability. As flexibility for our user's is very important to us, we want to make sure that users are able to communicate with the matches in the times they are available. Therefore, we consider users with no overlap as unmatchable.
  ...
  },
  {
    ...
    content: (
      <Text>
        {`Volunteers can specify a target group for their match. If specified, Volunteers can only be matched with a learner from that target group.`}
      </Text>
    ),
  },
  {
