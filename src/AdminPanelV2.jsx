...
} from './panel_v2/AdminPanelEmails';
import {
  AdminPanelV2_DevKit,
  DevkitSelector,
} from './panel_v2/AdminPanelDevkit';
...
function AdminPanelV2_Users(props) {
  ...
  const [selectedUsers, setSelectedUsers] = useState(
    initData?.selected_users ? initData.selected_users : [],
  );
  ...
  const {
    ...
    mutate,
    isLoading,
  } = useSWR(`/api/admin/user_listing_advanced/${list}/`, fetcher);
