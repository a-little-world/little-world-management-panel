    ...
    sub_buckets: [
      {
        ...
        description:
          'Matches that are over 10 weeks old, inactive, still in contact, and exchanged a desired number of messages and video calls.',
      },
      {
...
export const matchJourneyBuckets = [
  {
    id: 'pre-matching',
    title: 'Pre-Matching',
    sub_buckets: [
